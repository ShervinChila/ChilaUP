...
@Bot.on_message(filters.private & filters.user(ADMINS) & ~filters.command(['start','users','broadcast','بچ','genlink']))
async def channel_post(client: Client, message: Message):
    ...
    try:
        ...
        print(e)
        await reply_text.edit_text("قیمه ها ریخته شدن تو ماستا😐")
        return
    ...
    await reply_text.edit(f"<b>بفرما اینم لینک شما☺️</b>\n\n{link}", reply_markup=reply_markup, disable_web_page_preview = True)
